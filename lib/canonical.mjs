 ...
 * is deliberately NOT committed. Field set is frozen for scheme gitchain-ots-v1.
 */
export function buildCommittedFields({ id, category, claim, certainty, resolves_by, provenance, intent, committed_at, seq, prev, outcome, resolved_at }) {
  const fields = {
    id,
    category,
    claim,
